...
@section('content')
    ...
    @endphp
    <div class="container-fluid ps-4 pe-4"  style="position: fixed;right:0;bottom: 0;z-index: 1020;box-shadow:0 0px 10px 2px rgba(0, 0, 0, 0.2); background:#fff;">
        <div class="col-lg-10 col-12 m-auto">
            <div class="row pt-2 pb-2">
                ...
                <div class="col-5 p-0 d-flex justify-content-end align-items-center">
                    <button type="button" class="btn btn-lemon btn-unit-view " style="font-size: 20px;height:50px" @if ($SubScriptionStatus !== 'Y') disabled @endif>
                        ดูยูนิตที่เปิดจอง
                    </button>
                </div>
            </div>
        ...
        <div class="col-lg-10 col-md-12" style="padding-left: inherit; padding-right: inherit;">
            <div class="card event-detail ms-0 me-0" style="border: none;">
                <div class="card-body" style="padding-left: inherit; padding-right: inherit;">
                    <div class="container ps-4 pe-4 text-center">
                        <div class="col-12 mt-1 ">
                            กำลังจะหมดเวลา คลิกดูยูนิตได้เลย
                        </div>
                        <div class="d-flex justify-content-center gap-2" style="margin-left: 60px">
                            @include('layouts.flipdown', ['id' => 'flipdown-0'])
                        </div>
                        <div class="row g-4 mt-1">
                            <div class="col-12 mt-2 p-0">
                                <div class="text-green" style="font-size: 40px">
                                    <strong>คอนโดมิเนียม เอ สเปซ เมกา 2</strong>
                                </div>
                                <p class="fnt-28"><strong>เริ่มต้น : 1.99 ล้านบาท*</strong></p>
                            </div>
                            <div class="col-12 fnt-20 m-auto" style="color: #999">
                                เอ สเปซ เมกา คอนโดแห่งแรกใจกลาง MEGA CITY BANGNA ตอบสนองไลฟ์สไตล์คนยุคใหม่ที่ไม่จำกัด 24
                                ชั่วโมง "THE
                                COMPLETE LIFESTYLE HUB" “เมืองใหม่ในเมืองใหญ่” อภิมหาโปรเจคอสังหาฯ กว่า 400 ไร่
                                แวดล้อมไปด้วยสิ่งอำนวย
                                ความสะดวก กับ Facilities จัดเต็มพื้นที่ส่วนกลางครอบคลุม
                                กว่า 5 ชั้น สระว่ายน้ำ INFINITY EDGE POOL พร้อมสูดโอโซน
                                พื้นที่สีเขียวกว่า 4,000 ตร.ม. ออกแบบในสไตล์ FUTURISTIC MODERN DESIGN
                                ใช้เส้นสายที่สะท้อนถึงคนยุคใหม่
                                ถ่ายทอด
                        ...
                        <div class="row d-flex justify-content-center mt-3">
                            @if ($RegisStatus == 'N' && $SubScriptionStatus == 'N')
                                <div class="col-lg-11 col-md-12 ps-0 pe-0" id="Guest">
                            ...
                            @elseif ($RegisStatus == 'Y' && $SubScriptionStatus == 'N')
                                <div class="col-lg-11 col-md-12 ps-0 pe-0" id="Member">
                            ...
                            @else
                                <div class="col-lg-12 col-md-12 ps-4 pe-4 text-center" id="Customer">
